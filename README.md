# ![Logo](https://cdn.minevalley.eu/branding/logo_64px_cropped.png) - ChestLuckAPI

The ChestLuckAPI provides essential features and access to the locking system of MineValleyEU. This API is widely used 
in modules requiring block-based permissions.
...
<repository>
    <id>ChestLuckAPI</id>
    <url>https://maven.pkg.github.com/MineValley/ChestLuckAPI</url>
    <snapshots>
...
<dependency>
    <groupId>minevalley.chestluck</groupId>
